...
/** The doubleVar class which extends the Variable class. Stores the characteristics of the boolean
* variable such as the name, how deep in the scope, etc.
*/
public class DoubleVar extends Variable {
    /**
     * The constructor for the doubleVar class, calls the Variable super constructor
     ...
     */
    public DoubleVar(String Name, int depth, boolean initialized, boolean isfinal, boolean isglobal,
                     String type) {
