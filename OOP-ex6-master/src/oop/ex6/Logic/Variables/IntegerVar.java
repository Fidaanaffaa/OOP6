...
/** The IntegerVar class which extends the Variable class. Stores the characteristics of the boolean
 * variable such as the name, how deep in the scope, etc.
 */
public class IntegerVar extends Variable {
    /**
     * The constructor for the integerVar class, calls the Variable super constructor
     ...
     */
    public IntegerVar(String Name, int depth, boolean initialized, boolean isfinal, boolean isglobal,
                      String type) {
