...
/**
 * The StringVar class which extends the Variable class. Stores the characteristics of the boolean
 * variable such as the name, how deep in the scope, etc.
 */
public class StringVar extends Variable{
    /**
     * The constructor for the StringVar class, calls the Variable super constructor
     ...
     */
    public StringVar(String Name, int depth, boolean initialized, boolean isfinal, boolean isglobal,
                     String type) {
